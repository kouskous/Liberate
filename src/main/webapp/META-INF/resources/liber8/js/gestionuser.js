                ...
                success  : function(data) {  
                    ...
                    if(data.response ==="true") {
                     ...
                     $(".userproject").append('<li><div class="control-group">\n\
                                        <label class="control-label userline" for="selectError'+i+'">'+contenu[0].utilisateur+'</label>\n\
                                        <div class="controls userline"><input type ="text" value="'+contenu[0].droit+'" disabled></div></div>'); //add input box
                                ...
                                if(contenu[0].droit==='admin')
                                    {
                                        ...
                                        $(".userproject").append('<li><div class="control-group">\n\
                                        <label class="control-label userline" for="selectError'+i+1+'">'+contenu[i+1].utilisateur+'</label>\n\
